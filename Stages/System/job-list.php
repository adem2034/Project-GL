...
<head>
	...
	<title>stages - <?php echo "$title"; ?></title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/logo9.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employees.php">stagiaire</a>
							</li>
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as stagiaire</a>
						</div>
						...
						<div class="second-search-result-inner">
							...
							<div class="row">
								...
								<div class="col-xss-12 col-xs-6 col-sm-4 col-md-2">
									<button name="search" value="✓" type="submit" class="btn btn-block">Recherche</button>
								</div>
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								$sta = '<span class="job-label label label-primary">Umknown</span>';
								if ($type == "Freelance") {
										...
										<div class="content">
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">Voir cette stages</a>
													</div>
